...
$nilaiTujuan = array_slice($nilaiSiswa, 2);
$nilaiTujuan = array_slice($nilaiTujuan, 0, -2);
...
foreach($nilaiTujuan as $nilai) {
    $totalSkor+=$nilai;
    $count++;
    if ($count == (count($nilaiTujuan))) {
        echo "$nilai";
        continue;
    }
    echo "$nilai, ";
...
if ($diskon  > 0)
    echo "Selamat anda mendapat diskon $diskon% <br>";
